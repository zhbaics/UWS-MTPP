 ...
 */
public class ModifyVMDialog extends javax.swing.JDialog {

    //两个参数的构造器
    public ModifyVMDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    //四个参数的构造器
    public ModifyVMDialog(SanBootView view,VMHostInfo vmHostInfo, Vector _bindlist) {
        this(view, true);
        myInit(view, vmHostInfo, _bindlist);
    }
    ...
    //初始化
    public void myInit(SanBootView _view, VMHostInfo vmHostInfo, Vector _bindlist) {
        this.view = _view;
    ...
    public void initVMHostInfo(VMHostInfo vmh) {
        if (vmh != null) {
            ...
            jTextField6.setText(vmh.getVm_maxdisctime());
            jTextField7.setText(vmh.getVm_pingip());
            if("1".equals(vmh.getVm_ischeck())){
...
private void jTextField7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField7ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyVMDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ModifyVMDialog dialog = new ModifyVMDialog(new javax.swing.JFrame(), true);
