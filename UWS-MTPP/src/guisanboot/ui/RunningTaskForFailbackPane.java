/*
 * RunningTaskForFailbackPane.java
 *
 ...
 */
public class RunningTaskForFailbackPane extends javax.swing.JPanel {
    
    /** Creates new form RunningTaskForFailbackPane */
    public RunningTaskForFailbackPane() {
        initComponents();
    }
    
    public RunningTaskForFailbackPane( SanBootView view ) {
        this();
        myInit( view );
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Remove Persistent", jPanel11);
    ...
    public static int ASSIGN_DRIVER_ROW  = 2;
    public static int START_SERV_ROW     = 3;
    public static int REMOVE_PERSISTENT_TGT_ROW = 4;
    ...
    private void setupLanguage(){        
        ...
        jTabbedPane1.setTitleAt(index,
            SanBootView.res.getString("RunningTaskForDRPane.label.removePersistentTgt")
        );
    }
    ...
    public void assembleTask(){
        ...
        cnt++;
        task.seq = cnt;
        task.task = SanBootView.res.getString("common.DrRecover.connect1");
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskForFailbackPane.CONNECT_AGENT_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskForFailbackPane.STOP_SERV_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskForFailbackPane.ASSIGN_DRIVER_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskForFailbackPane.START_SERV_ROW = (cnt-1);
        
        task = new InitTask();
        cnt++;
        task.seq = cnt;
        task.task = SanBootView.res.getString("common.DrRecover.removePersistentTgt");
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskForFailbackPane.REMOVE_PERSISTENT_TGT_ROW = (cnt-1);
    }
    ...
    public String getTabStr( int which ){
        ...
        switch( which ){
            ...
            case 3:
                ...
                break;
            case 4:
                ret = SanBootView.res.getString("RunningTaskForDRPane.label.removePersistentTgt")+": ";
                break;
            default: 
                ret = "Unknown";
                break;
