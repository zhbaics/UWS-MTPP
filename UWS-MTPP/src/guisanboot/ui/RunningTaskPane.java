 ...
 */
public class RunningTaskPane extends javax.swing.JPanel implements RunningTask{ 
    
    /** Creates new form RunningTaskPane */
    public RunningTaskPane() {
        initComponents();
    }
    
    public RunningTaskPane( SanBootView view,int mode  ) {
        this();
        myInit( view,mode );
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Format Vol", jPanel14);
        ...
        jTabbedPane1.addTab("Copy OS", jPanel11);
    ...
    public static int FORMAT_VOL_ROW = 1;
    public static int GET_INFO_ROW = 2;
    public static int COPY_OS_ROW = 3;
    public static int SAVE_INFO_ROW = 4;
    ...
    private void setupLanguage(){
        ...
        jTabbedPane1.setTitleAt( index, 
            SanBootView.res.getString("RunningTaskPane.label.crtVol")
        );
        index = jTabbedPane1.indexOfComponent(jPanel14);
        jTabbedPane1.setTitleAt(index,
            SanBootView.res.getString("RunningTaskPane.label.formatVol")
        );
        ...
        jTabbedPane1.setTitleAt(index,
            SanBootView.res.getString("RunningTaskPane.label.copyOs")
        );
    }
    ...
    public void assembleTask(){
        ...
        RunningTaskPane.CRT_VOL_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskPane.FORMAT_VOL_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskPane.GET_INFO_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskPane.COPY_OS_ROW = (cnt-1);
        ...
        task.status = InitTask.INIT_TASK_STA_READY;
        taskList.addElement( task );
        RunningTaskPane.SAVE_INFO_ROW = (cnt-1);
    }
    ...
    public void freshCopyLogOnTabpane( String prefix,String log,int row,boolean isAutoScroll ){
        jTabbedPane1.setSelectedComponent( jPanel11 );
        printDupTaskString( prefix,log,isAutoScroll );
    }
    
    public void printDupTaskString( String prefix,String log,boolean isAutoScroll ){
        if( !prefix.equals("") ){
            jTextArea6.setText( prefix );
            jTextArea6.append( log);
        }else{
            jTextArea6.setText( log );
        }
        
        jTextArea6.setPreferredSize( new Dimension( 0,vertical_base+=15 ) ); 
        jTextArea6.getCaret().setDot( jTextArea6.getText().length() );
        jScrollPane7.scrollRectToVisible( jTextArea6.getVisibleRect() );
    }
    ...
    public String getTabStr( int which ){
        ...
        switch( which ){
            case 0:
                ...
                break;
            case 1:
                ret =  SanBootView.res.getString("RunningTaskPane.label.formatVol")+": ";
                break;
            case 2:
                ret =  SanBootView.res.getString("RunningTaskPane.label.getInfo")+": ";
                break;
            case 3:
                ret = SanBootView.res.getString("RunningTaskPane.label.copyOs")+": ";
                break;
            case 4:
