 ...
 */
public class ExportViewDialog extends javax.swing.JDialog {
    
    /** Creates new form AddLunMapDialog */
    public ExportViewDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public ExportViewDialog( SanBootView view ){
        this( view,true );
        myInit( view );
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( _clntuser.equals("") ){
            JOptionPane.showMessageDialog( this,
                SanBootView.res.getString("AddLunMapDialog.error.noneDrive")
            );
            return;
        }
        ...
        values[3] = _srvuser;
        values[4] = srv_passwd;
        values[5] = _clntuser; //driver letter
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExportViewDialog(new javax.swing.JFrame(), true).setVisible(true);
            }
        });
    }
    ...
    private void setupLanguage(){
        this.setTitle( SanBootView.res.getString("View.MenuItem.ExportView"));
        ...
        jLabel7.setText( SanBootView.res.getString("View.table.vmhost.letter") );
