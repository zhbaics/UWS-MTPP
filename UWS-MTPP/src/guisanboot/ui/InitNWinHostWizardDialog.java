...
public class InitNWinHostWizardDialog extends WizardDialogSample implements RecordUWSRptable,InitHostable {
    ...
    public InitNWinHostWizardDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public InitNWinHostWizardDialog( SanBootView view,BootHost selHost,boolean hasEnoughSpace ){
        super( view );
    ...
    private void myInit( SanBootView _view,BootHost selHost,boolean hasEnoughSpace ){
        ...
        setTipTextOnTopPane( SanBootView.res.getString("InitNWinHostWizardDialog.title") );
    ...
    private void setupLanguage1(){
        setTitle( SanBootView.res.getString("InitNWinHostWizardDialog.title") );
    }
...
SanBootView.log.error( this.getClass().getName(), "this hiden fs must be selected to protect: " + unixPart.dev_path + " mounted on " + unixPart.mp );
        ...
        if( getTipTitle().compareTo( SanBootView.res.getString("InitNWinHostWizardDialog.title").trim() ) == 0 ){
            setTipTextOnTopPane( SanBootView.res.getString("InitNWinHostWizardDialog.title1") );
