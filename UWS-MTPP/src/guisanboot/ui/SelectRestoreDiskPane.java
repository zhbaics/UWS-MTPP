 ...
 */
public class SelectRestoreDiskPane extends javax.swing.JPanel {
    
    /** Creates new form SelectRestoreDiskPane */
    public SelectRestoreDiskPane() {
        initComponents();
    }

    public SelectRestoreDiskPane( SanBootView view,DestAgent host,RestoreOriginalDiskInterface diag ) {
        this();
        myInit( view,host,diag,ResourceCenter.CMD_TYPE_MTPP );
    }

    public SelectRestoreDiskPane( SanBootView view,DestAgent host,RestoreOriginalDiskInterface diag,int mode ) {
        this();
...
//        jCheckBox2.setText( SanBootView.res.getString("SelectResotreDiskPane.checkBox.selectSnapshot") );
        ...
        if( mode == ResourceCenter.CMD_TYPE_CMDP ){
            ...
            this.jPanel7.remove( this.jCheckBox2 );
        }
...
//        }
    ...
    public boolean isSelectSnapshot(){
    ...
    public void setupTable( Vector list  ){
        ...
        for( i=0; i<num; i++ ){
            ...
            wrapper = new VolumeMapWrapper( 3 );
