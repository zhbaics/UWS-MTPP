...
/**
 * InitProgressRecord.java
 *
 * Created on 2010-6-23, 9:20:31
 */
public class InitProgressRecord implements TableRevealable {
    public final static String INIT_STATE   = "state"; 
    public final static String INIT_usetime = "usetime";
    public final static String INIT_speed   = "speed";
    public final static String INIT_copyed  = "copyed";
    public final static String INIT_leftime = "leftime";
    public final static String INIT_percent = "percent";
    
    public final static String STATE_init = "init";
    public final static String STATE_sync = "sync";
    public final static String STATE_async = "async";
    ...
    public InitProgressRecord(){
    }

    public InitProgressRecord( String disk ){
        this.disk = disk;
    }

    public InitProgressRecord( String status,String disk ){
        this.state = status;
        this.disk = disk;
    }
    ...
    public boolean isInitState(){
        return state.toUpperCase().equals( STATE_init.toUpperCase() );
    }
