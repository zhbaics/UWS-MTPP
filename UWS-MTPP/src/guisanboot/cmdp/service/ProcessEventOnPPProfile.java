/*
 * ProcessEventOnPPProfile.java
 *
 * Created on June 10, 2010, 16:17 PM
 */
 ...
 */
public class ProcessEventOnPPProfile extends GeneralProcessEventForSanBoot {
    BrowserTreeNode curProfileNode = null;
    
    /** Creates a new instance of ProcessEventOnPPProfile */
    public ProcessEventOnPPProfile(){
        this( null );
    }
    public ProcessEventOnPPProfile(SanBootView view) {
        super( ResourceCenter.TYPE_PPPROF,view );
    }
