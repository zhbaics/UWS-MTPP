...
/*
 * QuerySyncStateDialog.java
 *
 * Created on 2010-6-22, 15:52:11
 */
 ...
 * @author zjj
 */
public class QuerySyncStateDialog extends javax.swing.JDialog {

    /** Creates new form QuerySyncStateDialog */
    public QuerySyncStateDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public QuerySyncStateDialog( SanBootView view,VolumeMap volMap,BootHost host ) {
        this( view,true );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuerySyncStateDialog dialog = new QuerySyncStateDialog(new javax.swing.JFrame(), true);
        ...
        if( isOk ){
            if( view.initor.mdb.currentStateIsConnectError() ){
                ...
                if( view.initor.mdb.currentStateIsSync() ){
                    ...
                    String current_state = view.initor.mdb.getCurrentState();
                    if( view.initor.mdb.currentStateIsUnknown() ){
                        jLabel1.setText( SanBootView.res.getString("common.NotConsistent") );
                    }else{
                        jLabel1.setText( InitProgressRecord.getStateString( current_state ) );
                    }
                    if( current_state.equals( InitProgressRecord.STATE_init ) ){
                        this.jButton2.setText( SanBootView.res.getString("common.wait"));
                    }if( current_state.equals( InitProgressRecord.STATE_unknown ) ){
    ...
    private void updateWorkState(){
        ...
        if( isOk ){
            if( view.initor.mdb.workStateIsASync() ){
