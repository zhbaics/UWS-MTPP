 ...
 */
public class PhyFailoverWizardDialog extends WizardDialogSample implements FailoverInterface{
    ...
    public PhyFailoverWizardDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public PhyFailoverWizardDialog( SanBootView view,BootHost orgHost,boolean isSwitchDisk ){
        super( view );
...
//            }
    ...
    @Override public void nextButtonProcess(){
        ...
        Vector subnetList=null,ibootSrvList=null, allclientList=null;
        ArrayList netCardList;
        ...
        if( getTipTitle().compareTo(SanBootView.res.getString("FailoverWizardDialog.title2.5").trim() ) == 0 ){
            ...
            if( subnetList == null || ibootSrvList == null || allclientList == null){
                if( view.initor.dhcpdb.isLoginOK() ){   
                    subnetList = view.initor.dhcpdb.getSubnetListFromDhcp();
                    allclientList = view.initor.dhcpdb.getAllClient();
        ...
        if( allFinish && !isSkip ){
            ...
            if( useOdyDhcp ){
                ...
                if( isOk ){
                    ...
                    args += " -i "+dhcpInfo.ip + " -p " + simpleMac +" -n "+dhcpInfo.subnet + " -x "+ibootSrv + " -ostype windows";
