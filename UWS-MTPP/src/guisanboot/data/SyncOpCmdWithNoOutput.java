 ...
 */
    public class SyncOpCmdWithNoOutput extends AbstractNetworkRunning{
    private String cmd;
    private int pid = -1;
    
    /** Creates a new instance of SyncOpCmdWithNoOutput */
    public SyncOpCmdWithNoOutput() {
    }
    
    public SyncOpCmdWithNoOutput( Socket socket ) throws IOException{
        super( socket );
    }
