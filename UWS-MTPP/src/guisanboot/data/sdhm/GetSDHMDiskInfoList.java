 ...
 */
public class GetSDHMDiskInfoList extends NetworkRunning {

    private Vector sdhmUWSDiskTimeList = new Vector();
    private Vector sdhmUWSDiskInfoList = new Vector();
    private SanBootView view;

    /** Creates a new instance of GetSDHMDiskInfoList */
    public GetSDHMDiskInfoList(SanBootView _view, String cmd) throws IOException {
        super(cmd, _view.getSocket());
        view = _view;
    }

    public GetSDHMDiskInfoList(String cmd) {
        super(cmd);
    }
