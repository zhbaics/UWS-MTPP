 ...
 */
public class ImportProfile2 extends javax.swing.JDialog implements Backupable,Schedulerable {
    ...
    public ImportProfile2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public ImportProfile2( SanBootView view,BootHost host, BackupClient bkClnt,
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImportProfile2 dialog = new ImportProfile2(new javax.swing.JFrame(), true);
...
//        }
    ...
    public UniProfile collectBakInfo(UniProfile selectProfile){
        ...
        header.setPreCmd( bHeader.getPreCmd() );

        header.setPostCmd( bHeader.getPostCmd() );

        header.setSnapPreCmd( bHeader.getSnapPreCmd() );


        header.setSnapPostCmd( bHeader.getSnapPostCmd() );
        header.setLinux_lvm_snap( bHeader.getLinux_lvm_snap() );
...
//        }
        ...
        for( int i=0; i<size; i++ ){
            ...
            selectModel.addElement( profile );
