...
public class ProfileChooser extends JDialog {
    ...
    public ProfileChooser(
        ...
        try {
            jbInit();
            myInit2( view,bakable,mode,type,host );
            pack();
        }catch(Exception ex) {
            ex.printStackTrace();
        }
    ...
    public ProfileChooser(SanBootView view ,Backupable bakable,String title,int mode){
        this(view,bakable,title,true,mode,ResourceCenter.BAK_TYPE_FILE );
    }
    public ProfileChooser(SanBootView view ,Backupable bakable,String title,int mode,BootHost host){
        this(view,bakable,title,true,mode,ResourceCenter.BAK_TYPE_FILE,host );
    }
    ...
    private void myInit2( SanBootView _view,Backupable _bakable,int _mode,int _type,BootHost host ){
        view = _view;
        bakable = _bakable;
        mode = _mode;
        type = _type;
