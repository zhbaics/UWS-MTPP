...
public abstract class AbstractUniProfile {
    String lastLine = null;

    public AbstractUniProfile() {
    }

    public abstract void outputProfile(OutputStreamWriter out) throws IOException;
    public abstract int parserProfile(int begin,String[] lines );
    ...
    public Vector splitLine(String line){
        ...
        try{
            v.add( line.substring(0,pos).trim() );
