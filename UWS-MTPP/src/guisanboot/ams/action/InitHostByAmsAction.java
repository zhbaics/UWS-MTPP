...
import guisanboot.ams.ui.AmsInitBootHostWizardDialog;
 ...
 */
public class InitHostByAmsAction extends GeneralActionForMainUi{
    public InitHostByAmsAction(){
        super(
          ResourceCenter.BTN_ICON_INIT_16,
          ResourceCenter.BTN_ICON_INIT_50,
          "View.MenuItem.init",
          MenuAndBtnCenterForMainUi.FUNC_INIT_NWIN_AMS
        );
    }

    @Override public void doAction(ActionEvent evt){
SanBootView.log.info(getClass().getName(),"########### Entering not-window host's ams-init process" );
...
*/
        ...
        AmsInitBootHostWizardDialog dialog = new AmsInitBootHostWizardDialog( view,host,true );
...
SanBootView.log.info(getClass().getName(),"########### End of not-window host's ams-init process action. " );
    }
}
