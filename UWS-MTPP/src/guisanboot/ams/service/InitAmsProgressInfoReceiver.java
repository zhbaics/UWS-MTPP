...
public class InitAmsProgressInfoReceiver extends Thread{
    ...
    private ArrayList<InitAmsProgressRecord> recList = new ArrayList<InitAmsProgressRecord>();

    public InitAmsProgressInfoReceiver( SanBootView _view ){
        view = _view;
    ...
    public ArrayList<InitAmsProgressRecord> getInitProgress(){
        return this.recList;
    }
