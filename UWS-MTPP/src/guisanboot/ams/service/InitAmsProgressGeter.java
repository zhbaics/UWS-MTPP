...
public class InitAmsProgressGeter extends Thread{
    private QueryAmsInitProgressDialog queryInitProgressDiag;
    ...
    public InitAmsProgressGeter( 
        QueryAmsInitProgressDialog _diag,
        SanBootView _view,
        BootHost host,
        Cluster cluster
    ) {
    ...
    Runnable getInfoRun = new Runnable(){
        public void run(){
            try{
                GetInitAmsProgressIntoTableModel getTask = new GetInitAmsProgressIntoTableModel(
                    view,
                    host,
                    cluster
                );
